const animate1 = function (obj, target, callback) {
...
const warehouse = function () {
  ...
  // 获取轮播图的盒子
  const box = document.getElementById('warehouseBox1')

  // 获取轮播图
  var imgNum = box.getElementsByClassName('warehouseBoxItem1')
  ...
  var swiper = function () {
    ...
    animate1(box, -num * box.offsetWidth)
