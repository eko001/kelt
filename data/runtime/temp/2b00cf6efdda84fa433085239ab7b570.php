<?php /*a:2:{s:53:"themes/admin_simpleboot3/portal\admin_page\index.html";i:1670291596;s:91:"D:\phpstudy\phpstudy_pro\WWW\hualaogroup\public/themes/admin_simpleboot3/public\header.html";i:1670291596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <?php $status=array("1"=>'已发布',"0"=>'未发布'); if(is_array($pages) || $pages instanceof \think\Collection || $pages instanceof \think\Paginator): if( count($pages)==0 ) : echo "" ;else: foreach($pages as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo cmf_url('portal/Page/index',array('id'=>$vo['id'])); ?>" target="_blank">
