<?php /*a:2:{s:50:"themes/admin_simpleboot3/portal\contact\index.html";i:1670291596;s:91:"D:\phpstudy\phpstudy_pro\WWW\hualaogroup\public/themes/admin_simpleboot3/public\header.html";i:1670291596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li><a href="<?php echo url('Contact/add'); ?>">添加留言</a></li>
    </ul>
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('Contact/index'); ?>">
        ...
        <a class="btn btn-danger" href="<?php echo url('Contact/index'); ?>">清空</a>
    </form>
    <form class="js-ajax-form" action="" method="post">
        <div class="table-actions">
            <button class="btn btn-danger btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('Contact/delete'); ?>" data-subcheck="true" data-msg="您确定删除吗？">
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-xs btn-primary" href="<?php echo url('Contact/edit',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a>
                        <a class="btn btn-xs btn-danger js-ajax-delete"
                           href="<?php echo url('Contact/delete',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
                    </td>
                </tr>
