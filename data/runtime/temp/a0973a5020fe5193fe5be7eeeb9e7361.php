<?php /*a:2:{s:56:"themes/admin_simpleboot3/portal\admin_article\index.html";i:1670291596;s:91:"D:\phpstudy\phpstudy_pro\WWW\hualaogroup\public/themes/admin_simpleboot3/public\header.html";i:1670291596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($articles) || $articles instanceof \think\Collection || $articles instanceof \think\Paginator): if( count($articles)==0 ) : echo "" ;else: foreach($articles as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <?php if(!(empty($vo['categories']) || (($vo['categories'] instanceof \think\Collection || $vo['categories'] instanceof \think\Paginator ) && $vo['categories']->isEmpty()))): ?>
                            <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$vo['categories'][0]['id'])); ?>"
