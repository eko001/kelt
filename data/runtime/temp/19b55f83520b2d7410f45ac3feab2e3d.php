<?php /*a:2:{s:48:"themes/admin_simpleboot3/portal\contact\add.html";i:1670291596;s:91:"D:\phpstudy\phpstudy_pro\WWW\hualaogroup\public/themes/admin_simpleboot3/public\header.html";i:1670291596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('Contact/index'); ?>">留言管理</a></li>
        <li class="active"><a href="<?php echo url('Contact/add'); ?>">添加留言</a></li>
    </ul>
    <form action="<?php echo url('Contact/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>留言</th>
                        <td>
                            <textarea class="form-control" name="post[message]" style="height: 50px;"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a class="btn btn-default" href="<?php echo url('Contact/index'); ?>"><?php echo lang('BACK'); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
