<?php /*a:2:{s:45:"themes/admin_simpleboot3/portal\book\add.html";i:1670291596;s:91:"D:\phpstudy\phpstudy_pro\WWW\hualaogroup\public/themes/admin_simpleboot3/public\header.html";i:1670291596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('Book/index'); ?>">预约管理</a></li>
        <li class="active"><a href="<?php echo url('Book/add'); ?>">添加预约</a></li>
    </ul>
    <form action="<?php echo url('Book/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>公司名称</th>
                        <td>
                            <input class="form-control" type="text" name="post[companyname]" id="companyname" value=""
                                   placeholder="请输入公司名称">
                        </td>
                    </tr>
                    <tr>
                        <th>电话</th>
                        <td><input class="form-control" type="text" name="post[phone]" id="phone" value=""
                                   placeholder="请输入电话"></td>
                    </tr>
                    <tr>
                        <th>邮箱</th>
                        <td><input class="form-control" type="text" name="post[email]" id="email" value=""
                                   placeholder="请输入邮箱"></td>
                    </tr>
                    <tr>
                        <th>业务描述</th>
                        <td>
                            <textarea class="form-control" name="post[buisiness]" style="height: 50px;"
                                      placeholder="请填写业务"></textarea>
                        </td>
                    </tr>
                  <!--  <tr>
                        <th>内容</th>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a class="btn btn-default" href="<?php echo url('Book/index'); ?>"><?php echo lang('BACK'); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
