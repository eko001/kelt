...
class IndexController extends HomeBaseController
{
    ...
    {
        // 产品服务
//        $productList = Db::name('portal_category')->alias('c')->field('c.*')->leftJoin('portal_category p', 'p.id=c.parent_id')->where("p.parent_id", 30)->where("c.status", 1)->limit(0, 8)->order('c.list_order', 'desc')->select()->toArray();
//
//        //新闻中心
